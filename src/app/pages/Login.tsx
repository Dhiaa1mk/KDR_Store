...
export function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success('Connexion réussie !', {
      description: 'Bienvenue sur KDR__STORE',
    });
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl mb-2 text-white">Connexion</h1>
          <p className="text-muted-foreground">Accédez à votre compte KDR__STORE</p>
        </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="bg-card px-2 text-sm text-muted-foreground">Ou continuer avec</span>
              </div>
            </div>
